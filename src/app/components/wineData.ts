...
export const wines: WineProduct[] = [
  ...
  // ID 17: Frankovka 2023
  {
    ...
    vintage: 2023,
    price: 229,
    description: "Víno nádherné barvy s rubínovými odlesky. Svěží ovocná vůně s třešňovými tóny je v harmonickém souladu s chutí umocněnou tříslovinou. V chuti dominují přezrálé višně a delikátní tóny švestkové marmelády, jemně se snoubící s chutí ostružin.",
    category: 'red',
    image: 'https://cdn.myshoptet.com/usr/shop.miqueen.cz/user/shop/big/114_fr-png.png?677fa791',
